...
X_obs = CSV.read("/home/syu/Documents/Projects/ipo_kdd/ipo/data/drl/drl_50_assets_target1.1/arlio_X.txt",delim=",",datarow=1);
X_obs = Matrix(X_obs);
X_obs = X_obs[:,1:end]
...
for sind=1:10:100
    ...
    for ind=1:1:425
        A_return = CSV.read("/home/syu/Documents/Projects/ipo_kdd/ipo/data/drl/drl_50_assets_target1.1/arlio_A_"*string(ind)*".txt",datarow=1);
...
save("/home/syu/Documents/Projects/ipo_kdd/ipo/results/A_50assetnew_10_obs_1L_1M.jld","A",A)
npzwrite("/home/syu/Documents/Projects/ipo_kdd/ipo/results/A_50assetnew_10_obs_1L_1M.npy", A)
